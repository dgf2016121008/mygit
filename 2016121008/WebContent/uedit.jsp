...
<div class="ibody">
  ...
  <%
							...
							Blogtext blogtext = DBUtils.doUQ(request.getParameter("bid"));
							if(blogtext!=null){
						%>
			...
			<div class="table-responsive">
				<table class="table table-striped">
					...
					<tr>
							...
							<td><input  name="bid" type="text" required="required" value="<%=blogtext.getBid() %>"></td>
							<td><input  name="name" type="text" required="required" value="<%=blogtext.getName() %>"></td>
							<td><input  name="type" type="text" required="required" value="<%=blogtext.getType() %>"></td>
